...
import type { VFormFieldTreeSelectTransferProps } from '../../../../types'
...
<template>
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-px min-h-8">
    <ProScrollArea class="sm:rounded-none sm:rounded-l-md ring ring-accented px-2 py-1">
      <UTree
    ...
    <ProScrollArea class="sm:rounded-none sm:rounded-r-md ring ring-accented px-2 py-1">
